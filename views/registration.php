        ...
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" onsubmit="formValidate();" id="registerForm">
                    <div class="mb-3">
                        <label for="username" class="form-label">Felhaszanlonev</label>
                        ...
                        <br>
                        <label for="fullName" class="form-label">Teljes Nev</label>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" name="email" id="email" aria-describedby="helpId"
                            placeholder="" required value="<?php if(isset($_POST['email'])) echo $_POST['email']; ?>"/>
