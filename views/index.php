...
<!-- Main Content Div után-->
    ...
    window.onload = document.getElementById('content').innerHTML=`    <div class="container" >
              ...
              <div id="${a.id}" class="carousel slide" style="padding: 10px">
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img src="../public/img/${a.img1}" class="d-block w-100" alt="1">
                    </div>
                    <div class="carousel-item">
                      <img src="../public/img/${a.img2}" class="d-block w-100" alt="2">
                    </div>
                    <div class="carousel-item">
                      <img src="../public/img/${a.img3}" class="d-block w-100" alt="3">
                    </div>
                  </div>
