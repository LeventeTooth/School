            ...
            <div style="margin: 20px; background-color: beige; height: 80vh; width: 100%; border-radius: 20px; padding: 30px">
                ...
                <form method="POST" action="../controllers/login.php">
                    <div class="form-floating mb-5 mt-5">
                        <input type="text" class="form-control" id="floatingInput" name="felhasznalonev" placeholder="">
                        <label for="floatingInput">Felhasznalo nev</label>
                    </div>
                    ...
                    <div class="mt-5">
                        ...
                        <button class="btn btn-primary" id="submit" type="submit">Belepes</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="col-sm-6">
            <div style="margin: 20px; background-color: beige; height: 80vh; width: 100%; border-radius: 20px; padding: 30px">
                ...
                <form method="get" action="registration.php">
                    ...
                    <div class="mt-5">
                        <button class="btn btn-primary" id="submit" type="submit" href="registration.php" >Regisztracio</button>
                    </div>
                </form>
            </div>
            </div>
